...
//        setTabBarVisible(false, animated: true)
    ...
    private func dismissActionViewWithDelay() {
        NSTimer.scheduledTimerWithTimeInterval(0.5, target: self, selector: #selector(OldRestaurantsViewController.dismissActionView), userInfo: nil, repeats: false)
    }
    
    @objc private func dismissActionView() {
        self.restaurantsTable.setEditing(false, animated: true)
        NSTimer.scheduledTimerWithTimeInterval(0.5, target: self, selector: #selector(OldRestaurantsViewController.reloadTable), userInfo: nil, repeats: false)
    }
    ...
    func getId() -> String {
        return "OldRestaurantsViewController"
    }
